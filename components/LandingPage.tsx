        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-xl shadow-slate-200/50 p-8 flex flex-col">
          ...
          <div className="space-y-4 flex-grow">
            <div className="flex gap-3 text-slate-600 leading-relaxed">
              ...
              <p>
                This software requires the <strong>original / consolidated file</strong> or <strong>FVU output</strong> 
                (files with <code className="bg-slate-100 px-1 rounded text-emerald-700">.xlsx</code>, 
                <code className="bg-slate-100 px-1 rounded text-emerald-700">.csv</code> or 
                <code className="bg-slate-100 px-1 rounded text-emerald-700">.fvu</code> extensions).
              </p>
            </div>
            ...
            <div className="p-4 bg-amber-50 border border-amber-100 rounded-xl">
              <p className="text-sm text-amber-800 leading-relaxed">
                ...
                eTDS Corrector supports consolidated data and FVU files from <strong>eTdsWizard, TdsPac, SalTds,</strong> or <strong>PayPac</strong> registered accounts.
              </p>
            </div>
          </div>
        ...
        <div className="bg-slate-900 rounded-2xl border border-slate-800 p-8 text-white shadow-2xl flex flex-col">
          ...
          <div className="space-y-4 flex-grow">
            <p className="text-slate-300 text-sm leading-relaxed">
              ...
              file formats issued by <strong>NSDL / TRACES</strong>, including FVU V8.7 support.
            </p>
            <p className="text-slate-300 text-sm leading-relaxed">
              We shall not be held responsible for any data loss occurring due to new file format updates. 
              Corrections made in previously downloaded consolidated data or FVU files may need to be reset for full compatibility.
            </p>
          </div>
